$(document).ready(function() {
  ...
  var apiRoot = 'https://tasks-prod-kodilla-tasks-dxdm5v.mo5.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://tasks-prod-kodilla-tasks-dxdm5v.mo5.mogenius.io/v1/trello';
